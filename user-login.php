      ...
      <div class="col-md-6">
        ...
        <form action="" method="post">
          <div class="form-group">
            ...
            <input type="text" name="username" id="username" class="form-control" placeholder="Username" aria-describedby="helpId" required autofocus>
          </div>
...
<br>
          <a href="user-signup.php"  style="margin:10px 0px">Create New Account, Click Here!</a> <br>
          <a href="reset-password.php"  style="">Forgot Password?</a>
        </form>
        <?php
