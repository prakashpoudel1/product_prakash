...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-primary">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <!-- Navbar brand -->
                <a class="navbar-brand mt-2 mt-lg-0 text-dark bg-danger" href="#">
                    Fun Olympics Games 2024
                </a>
                <!-- Left links -->
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="news.php">Events & News</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="photo-gallery.php">Photos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="booking.php">Book your Ticket</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="video-gallery.php">Watch Live</a>
                    </li>
                    <li class="nav-item">
            ...
            <!-- Collapsible wrapper -->
            <a class="btn btn-primary" href="user-login.php">User Log In</a> &nbsp;
    ...
    <div class="row">
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center text-white p-3 py-5"><img class="rounded-circle mt-5" width="150px" src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg"><span class="font-weight-bold text-white">PrakashPoudel</span><span class="text-black-50">Prakash@gmail.com</span><span> </span></div>
        </div>
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    <div class="col-md-6"><label class="labels">Name</label><input type="text" class="form-control" placeholder="first name" value="Prakash"></div>
                    <div class="col-md-6"><label class="labels">Surname</label><input type="text" class="form-control" value="Poudel" placeholder="surname"></div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-12"><label class="labels">Mobile Number</label><input type="text" class="form-control" placeholder="enter phone number" value="+977-9865509187"></div>
                    <div class="col-md-12"><label class="labels">Address </label><input type="text" class="form-control" placeholder="enter address " value="Bharatpur"></div>
                    <div class="col-md-12"><label class="labels">District</label><input type="text" class="form-control" placeholder="enter district" value="Chitwan"></div>
                    <div class="col-md-12"><label class="labels">Country</label><input type="text" class="form-control" placeholder="enter Country" value="Nepal"></div>
                    <div class="col-md-12"><label class="labels">Email ID</label><input type="text" class="form-control" placeholder="enter email id" value="Prakash@gmail.com"></div>
                    </div>
    ...
    <footer id="footer" class="footer-1">
        <div class="main-footer  bg-primary widgets-dark typo-light">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="widget subscribe no-box">
                            ...
                            <p>Welcome to our official website for Paris Fun Olympic 2024 </p>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="widget no-box">
                            ...
                            <p>Signup to get access to live videos in our website</p>
                            <a class="btn-success btn-lg" href="user-signup.php" target="_blank">Sign Up Now</a>
                        </div>
                    </div>
        ...
        <div class="footer-copyright bg-primary text-dark">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center text-dark">
                        <p class="text-white">Copyright FunOlympics © 2024. All rights reserved.</p>
                        <br>
                        <p class="text-white">Designed By Prakash Poudel.</p>
                    </div>
                </div>
            </div>
        </div>
