                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 ">
                            ...
                            <form action="" method="post">
                                ...
                                <button type="submit" class=" btn-success btn-lg" name="submit">Create New User</button>
                                <button type="reset" class=" btn-danger btn-lg">Cancel</button>
                                <a href="user-login.php" class=" btn-primary btn-lg btn-block" style="margin:10px 0px">Log in</a>
                            </form>
                            <?php
