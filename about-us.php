...
<div class="container" style="padding: 40px;">
        <div class="row">
            <div class="col-md-9">
                <h2>About Us!</h2>
                <p>The Olympics is a prestigious international sporting event held every four years, bringing together athletes from all over the world to compete in a wide range of sports. Rooted in ancient Greek traditions, the modern Olympic Games symbolize unity, friendship, and fair competition among nations. Hosted by different countries each time, the event showcases the incredible talent, dedication, and hard work of athletes in various disciplines, including athletics, swimming, gymnastics, and many others. Beyond sports, the Olympics promote cultural exchange and foster global understanding, serving as a platform for nations to come together and celebrate the power of sportsmanship and human achievement. The spirit of the Olympics continues to inspire generations, transcending borders and leaving a lasting legacy of excellence, camaraderie, and peace. </P> </div>
...
<div class="jumbotron jumbotron-fluid">
      ...
      <div class="container" style="padding: 40px;">
        <div class="row">
            <div class="col-md-9">
            <h5>Contact Us</h5>
        <p>Email: poudelprakash272@gmail.com</p>
        <p>Phone:+977-9867927363</p>
		    <br>
