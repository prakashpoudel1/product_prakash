...
<div id="carouselId" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="carousel-item active" style="height: 42em">
				<img src="img/paris.jpg" alt="First slide" class="w-100 h-100">
				<div class="carousel-caption d-none d-md-block">
				
				</div>
			</div>
			<div class="carousel-item" style="height: 42em">
				<img src="img/oly.jpg" alt="Second slide" class="w-100 h-100">
				<div class="carousel-caption d-none d-md-block">
					
				</div>
			</div>
			<div class="carousel-item" style="height: 42em">
				<img src="img/4.png" alt="Third slide" class="w-100 h-100">
				<div class="carousel-caption d-none d-md-block">
					
				</div>
			</div>
			<div class="carousel-item" style="height: 42em">
				<img src="img/stadium.jpg" alt="Third slide" class="w-100 h-100">
				<div class="carousel-caption d-none d-md-block">
  ...
  <div class="container" style="padding: 30px;">
		<h2 class="display-4 text-center">Trending News and Events</h2>
		<hr class="my-2">
		<div class="row">
        <?php
        ...
        while ($row = mysqli_fetch_array($run)) {
            ...
            <div class="col-md-4" >
				<h2><?php echo $b; ?></h2>
				<img src="images/<?php echo $d; ?>" alt="web" class="img-thumbnail">
				<p><?php echo substr($c,0,100); ?> ........ </p>
				<a href="news.php?id=<?php echo $a; ?>"
