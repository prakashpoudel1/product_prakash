            ...
            <div class="col-md-9">
                <form action="" method="post">
                   ...
                   <!-- Games -->
                    ...
                    <button type="submit" class=" btn-success btn-lg" name="submit">Book Now</button>
                ...
                if(isset($_POST['submit']))
                {
                    ...
                    $g=$_POST['game'];
                    $h=$_POST['country'];
                    $query="insert into bookings(firstname , lastname, gender, address, phone, email, game, country)values('$a','$b','$c','$d','$e','$f','$g','$h')";
...
<div class="main-footer bg-primary idgets-dark typo-light">
<div class="container">
<div class="row">
...
<a class="btn-success btn-lg" href="user-signup.php" target="_blank">Sign Up Now</a>Sign Up Now</a>
</div>
</div>
